...
const DataFetcher = Ember.Object.extend({
  ...
  @computed('datatag') indices(datatag) {
    return datatag.get('indices');
  },
  @computed('datatag') onFrames(datatag) {
    return datatag.get('on_frames');
  },
  @computed('datatag') bsFrames(datatag) {
...
export default Ember.Component.extend({
  ...
  datatag: Ember.Object.create({ meantrace: [], matrix: [], indices: {}, on_frames: null, bs_frames: null }),
